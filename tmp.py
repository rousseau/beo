...
T1image = nibabel.load('/home/rousseau/Sync/Experiments/IXI/IXI662-Guys-1120-T1.nii.gz')
T2image = nibabel.load('/home/rousseau/Sync/Experiments/IXI/IXI662-Guys-1120-T2.nii.gz')
PDimage = nibabel.load('/home/rousseau/Sync/Experiments/IXI/IXI662-Guys-1120-PD.nii.gz')
maskarray = nibabel.load('/home/rousseau/Sync/Experiments/IXI/IXI662-Guys-1120-T1_bet_mask.nii.gz').get_data().astype(float)

prefix = 'chp6_nowindowing'
prefix+= '_e'+str(epochs)+'_ps'+str(patch_size)+'_mp'+str(n_patches)
...
nibabel.save(image_T1_to_T2,'/home/rousseau/Sync/Experiments/IXI/'+prefix+'T1_to_T2.nii.gz')
...
nibabel.save(image_T2_to_PD,'/home/rousseau/Sync/Experiments/IXI/'+prefix+'T2_to_PD.nii.gz')
...
nibabel.save(image_T1_to_PD,'/home/rousseau/Sync/Experiments/IXI/'+prefix+'T1_to_PD.nii.gz')

image_T1_to_T2_to_PD = apply_model_on_3dimage(model_T2_to_PD, image_T1_to_T2, mask=maskarray)
nibabel.save(image_T1_to_T2_to_PD,'/home/rousseau/Sync/Experiments/IXI/'+prefix+'T1_to_T2_to_PD.nii.gz')
